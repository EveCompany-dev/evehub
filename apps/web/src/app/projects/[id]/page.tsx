...
import { ProjectDetailWorkspace } from '../../../components/ProjectDetailWorkspace';
import { getSessionUser } from '../../../lib/session';

export const dynamic = 'force-dynamic';

/** Open to any authenticated workspace member — same as Jobs, which is where this page is linked from. */
export default async function ProjectPage({ params }: { params: Promise<{ id: string }> }): Promise<JSX.Element> {
  ...
  return (
    <div className="eve-wide-page">
      <header className="eve-wide-page__header">
        ...
        <h1 className="eve-profile__title">Projeto</h1>
      </header>
