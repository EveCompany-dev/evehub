...
const DESKTOP_ALERT_TYPES: NotificationType[] = ['markedImportant', 'teamMessageMention', 'scheduledPostFailed', 'connectorSyncFailed', 'passwordResetRequested', 'bugReport'];
