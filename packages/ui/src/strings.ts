...
export const strings = {
  ...
  canvas: {
    empty: 'Board vazio.',
    emptyHint: 'Clique com o botão direito para adicionar um módulo, ou abra o Ctrl+K.',
    addModule: 'Adicionar módulo',
    addText: 'Adicionar texto',
    pasteImage: 'Colar imagem',
    needsSetup: 'pede conexão',
    textPlaceholder: 'Clique duas vezes para escrever',
    editText: 'Editar texto',
    renameModule: 'Renomear módulo',
    renamePrompt: 'Nome do módulo neste board:',
    duplicate: 'Duplicar',
    lockNode: 'Travar',
    unlockNode: 'Destravar',
    locked: 'Travado',
    lockedBoard: 'Board travado',
    lockBoard: 'Travar board inteiro',
    bringToFront: 'Trazer para frente',
    sendToBack: 'Enviar para trás',
    renameScreen: 'Renomear tela',
    renameScreenPrompt: 'Nome da tela:',
    fitScreen: 'Enquadrar esta tela',
    fitAll: 'Enquadrar tudo',
    fitAllShort: 'Enquadrar',
    zoomReset: 'Zoom 100%',
    showGrid: 'Mostrar grade',
    snapToGrid: 'Alinhar à grade',
    undo: 'Desfazer',
    connectHint: 'Arraste para ligar a outro módulo',
    resizeHint: 'Arraste para redimensionar',
    labelLink: 'Nomear ligação',
    labelLinkPrompt: 'Texto da ligação:',
    removeLink: 'Remover ligação',
    missingInstance: 'Este módulo aponta para uma conexão que não existe mais.',
    uploading: 'Enviando imagem...',
    modeTitle: 'Modo da dashboard',
    modeCanvas: 'Canvas livre',
    modeGrid: 'Grade de 12 colunas',
    modeHint:
      'O canvas deixa posicionar, duplicar e ligar módulos livremente. A grade é o layout antigo, em colunas. Trocar de modo não apaga nada: cada um guarda o seu próprio arranjo.',
    sectionScreens: 'Telas',
    sectionModules: 'Módulos no board',
    goToScreen: 'Ir para a tela',
